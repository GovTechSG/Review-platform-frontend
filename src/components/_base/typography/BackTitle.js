...
export default class BackTitle extends React.Component {
  static contextTypes = {
    router: React.PropTypes.object.isRequired
  };

  handleClick() {
    this.props.routeViaWindowLocation ? window.location = this.props.link : this.context.router.push(this.props.link);
  }

  render() {
    return (
      <a className="back-title-container" onClick={_.debounce(this.handleClick.bind(this), 250, { leading: true, trailing: false })}>
